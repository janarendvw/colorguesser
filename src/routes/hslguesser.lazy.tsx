...
import { ColorGenerator } from "../utils/ColorFabric";
...
function Hslgueser() {
  ...
  const { generatedColor, setGeneratedColor, guessedHslColor } = useStore();
          ...
          <div className="flex flex-col gap-2">
            {attempts.length < 5 ? (
              <>
                ...
                <p
                  style={{
                    opacity: guessedHslColor.includes(null) ? "0.4" : "1",
                  }}
                  className="text-white"
                >
                  &#x21AA; Press <b className="bg-white/20 px-2">Enter</b> to
                  submit
                </p>
              </>
            ) : (
